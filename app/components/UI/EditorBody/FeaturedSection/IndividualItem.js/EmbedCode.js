  ...
  return (
    <div ref={props.provided.innerRef} {...props.provided.draggableProps} {...props.provided.dragHandleProps} className="flex gap-2 justify-start items-center max-w-[416px] bg-gray-100 rounded-lg p-1" >
      ...
      <div className='bg-gray-100 rounded-lg grow flex justify-start items-center'>
        <textarea
          name="text"
          onBlur={changeText} placeholder='Paste map embed code' className="w-full border-gray-300 bg-primary-light-blue text-gray-900 placeholder-gray-600  p-4 h-16 rounded-xl focus:border-primary-dark-blue2 focus:border-[1px] border-[1px] focus:outline-none" />
      </div>
